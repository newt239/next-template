...
export const Slider = ({ className, ...props }: React.ComponentProps<typeof PrimitiveSlider>) => (
  <PrimitiveSlider
    data-slot="control"
    className={cx(
...
export const SliderFill = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
