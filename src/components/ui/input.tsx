...
export const InputGroup = ({ className, ...props }: GroupProps) => (
  <Group
    ...
    className={cx(
      ...
      "[&>[data-slot=icon]:first-child]:inset-s-3 sm:[&>[data-slot=icon]:first-child]:inset-s-2.5 [&>[data-slot=icon]:last-child]:inset-e-3 sm:[&>[data-slot=icon]:last-child]:end-2.5",
      ...
      "[&>[data-slot=loader]:first-child]:inset-s-3 sm:[&>[data-slot=loader]:first-child]:inset-s-2.5 [&>[data-slot=loader]:last-child]:inset-e-3 sm:[&>[data-slot=loader]:last-child]:end-2.5",
      ...
      "[&>[data-slot=text]:first-child:not([class*='start-'])]:inset-s-3 sm:[&>[data-slot=text]:first-child:not([class*='start-'])]:inset-s-2.5 [&>[data-slot=text]:last-child:not([class*='end-'])]:end-3 sm:[&>[data-slot=text]:last-child:not([class*='end-'])]:end-2.5",
      ...
      "[&>[data-slot=keyboard]:first-child:not([class*='start-'])]:inset-s-3 sm:[&>[data-slot=keyboard]:first-child:not([class*='start-'])]:inset-s-2.5 [&>[data-slot=keyboard]:last-child:not([class*='end-'])]:end-3 sm:[&>[data-slot=keyboard]:last-child:not([class*='end-'])]:end-2.5",
