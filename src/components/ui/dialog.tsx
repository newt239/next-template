...
const DialogCloseIcon = ({ className, ...props }: CloseButtonIndicatorProps) =>
  props.isDismissable ? (
    <PrimitiveButton
      ...
      slot="close"
      className={cx(
        "close absolute inset-e-1 top-1 z-50 grid size-8 place-content-center rounded-xl hover:bg-secondary focus:bg-secondary focus:outline-hidden focus-visible:ring-1 focus-visible:ring-primary sm:end-2 sm:top-2 sm:size-7 sm:rounded-md",
        className,
      )}
    >
